...
public class StatisticsLogger {
    private static final String NAME = "com.wrapper.dubbo.statistics.StatisticsLogger";
    ...
    private static void initLogger() {
        ...
        try {
            ...
            if (classType.getName().equals("org.slf4j.impl.Log4jLoggerFactory")) {
                ...
                URL url = StatisticsLogger.class.getClassLoader().getResource("dubbo-statistics/log4j.xml");
                ...
                URI uri = StatisticsLogger.class.getClassLoader().getResource("dubbo-statistics/log4j2.xml").toURI();
                Constructor<?> loggerContextConstructor = loggerContextClass.getConstructor(String.class, Object.class, URI.class);
                Object loggerContext = loggerContextConstructor.newInstance("statisticLogger", null, uri);
                ...
                Object statisticLogger = getLoggerMethod.invoke(loggerContext, NAME);
                ...
                LOGGER = (Logger) log4jLoggerConstructor.newInstance(statisticLogger, NAME);
                ...
                URL url = StatisticsLogger.class.getClassLoader().getResource("dubbo-statistics/logback.xml");
