...
public class Constants {
    ...
    public static final String  PROVIDER_TIMESTAMP_KEY             = "provider.timestamp";
    ...
    public static final int    STATISTIC_PERIOD = 30;
    ...
    public static final String WD_VAP_METHOD                       = "wd_vap_method";
    ...
    public static final String APP_NAME = System.getProperty("project.name", "");
    ...
    public static final String SMART_CLUSTER = "smart";
}
