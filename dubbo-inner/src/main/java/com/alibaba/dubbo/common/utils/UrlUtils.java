...
public class UrlUtils {
    ...
    /**
     *  1. 如果protocol是zookeeper,那么 默认端口改为 2181
     *  2. 其他情况,跟原来保持一直: 9090
     */
    private static int getDefaultPort(URL u) {
        return u != null && "zookeeper".equalsIgnoreCase(u.getProtocol()) ? DEFAULT_ZOOKEEPER_PORT : 9090;
    }
